...
function changeImage() {
    document.getElementById('taskImage').src = 'Images/CssLogo.png';
}
function resetImage() {
    document.getElementById('taskImage').src = 'Images/HtmlLogo.png';
}
...
function calculate(operation) {
    ...
    if (operation == '+') {
        ...
        if(num2 == 0){
            result = 'The number can not be divided by zero';
        }
        else{
            result = num1 / num2;
        }
